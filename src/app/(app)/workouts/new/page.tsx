...
export default function NewWorkoutPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/workouts?startDate=${today.toISOString()}&endDate=${tomorrow.toISOString()}&limit=1`)
      .then((r) => r.json())
      .then((data) => {
    ...
    <div className="max-w-2xl mx-auto pb-32">
      ...
      {todayWorkoutId && (
        <div className="mx-4 mt-3 flex items-center gap-2 px-3 py-2.5 rounded-xl bg-accent-green/10 border border-accent-green/20">
          ...
          <p className="text-xs text-accent-green font-medium">You worked out today — duplicate exercises will be added to existing one.</p>
        </div>
      )}
